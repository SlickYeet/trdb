      ...
      <section className="py-12 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
            <div className="rounded-2xl bg-card p-6 text-center ring-2 ring-border transition-colors duration-200">
      ...
      <section className="border-border border-t py-16 sm:py-20">
        <div className="mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mb-8 max-w-2xl text-balance text-muted-foreground">
            Save your favorites, share them with friends, and never lose a
            recipe again!
          </p>
          <Link
            className={cn(
